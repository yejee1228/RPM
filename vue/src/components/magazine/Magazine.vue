                ...
                <div class="main_content">
                    ...
                    <div class="mc_wide_searchbox">
                        <vue-word-cloud
                                ...
                                :rotation="([, weight]) => weight > 6 ? rotationItems[0] : rotationItems[1]"
                                :spacing = spacing
                                ...
                                <div class="search3box">
                                    <div id="divTabWant1" class="divTabWantGroup">
                                        <div class="searchcont1">
                                            <ul >
                                               <li v-if="isAnyCar">
                                                   <span style="font-size: 25px; font-family: 'Segoe UI';">선택하신 키워드 : <b>{{selectedItem}}</b></span><br/>
                                                   <span  style="font-size: 20px; font-family: 'Segoe UI';">  <b>제품</b> 관련 키워드로 <b>RPM 보유 상품</b>을 우선으로 보여 드립니다.</span><br/>
                                               </li>
                                                <li v-if="isAnyArticle && !isAnyCar">
                                                    <span style="font-size: 25px; font-family: 'Segoe UI';"> 선택하신 키워드 : <b>{{selectedItem}}</b></span><br/>
                                                    <span style="font-size: 20px; font-family: 'Segoe UI';">  <b>기사</b> 관련 키워드로 <b>기사</b>를 보여 드립니다.</span><br/>
                                               </li>
                                                <li v-if="!isAnyArticle && !isAnyCar">
                                                   <span style="font-size: 25px; font-family: 'Segoe UI';">  최근 2년간 기사의 형태소를 분석하여 워드 클라우드로 보여드립니다.</span><br/>
                                                    <span style="font-size: 15px; font-family: 'Segoe UI';"> 관심있는 <b>키워드</b>를 선택하시면 관련 내용을 확인하실 수 있습니다. </span>
                                               </li>
                                            </ul>
                                        </div>
                                    </div>
